...
import { homeQuiz, type HomeQuizLang } from '@/lib/translations/home-quiz'
...
export function HomeQuizPanel() {
  ...
  const quizLang: HomeQuizLang = lang === 'kr' ? 'kr' : lang === 'en' ? 'en' : lang === 'es' ? 'es' : 'fr'
  const questions = homeQuiz[quizLang] ?? homeQuiz.fr
