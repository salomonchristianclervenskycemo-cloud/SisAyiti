  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-border bg-background shadow-xs hover:bg-muted/50 hover:border-primary/50 dark:bg-input/30 dark:border-input dark:hover:bg-input/50',
        secondary:
          'bg-secondary text-secondary-foreground hover:bg-secondary/80 shadow-sm hover:shadow-md active:scale-95',
        ghost:
          'hover:bg-muted/50 text-foreground dark:hover:bg-accent/50',
        link: 'text-primary underline-offset-4 hover:underline',

        /* NEW LIGHT MODE OPTIMIZED VARIANTS */
        'light-solid': 'bg-foreground/10 text-foreground hover:bg-foreground/15 border border-border shadow-xs hover:shadow-sm',
        'light-subtle': 'bg-muted/40 text-foreground hover:bg-muted/60 shadow-xs hover:shadow-sm',
        'light-outline': 'border-2 border-primary text-primary hover:bg-primary/5 shadow-xs',
        'light-accent': 'bg-accent text-accent-foreground hover:bg-accent/90 shadow-sm hover:shadow-md active:scale-95',
        'light-ghost': 'hover:bg-muted/50 text-foreground',
      },
      size: {
