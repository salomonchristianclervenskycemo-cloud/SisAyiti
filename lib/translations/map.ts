...
export const mapTopBarT: Record<MapLang, Record<string, string>> = {
  ...
  ht: { title: "Kat tranblemanntè Ayiti", subtitle: "Siveyans USGS / EMSC", active: "AKTIF", sync: "SENK", lastUpdated: "Dènye mizajou", events: "evènman" },
...
export const mapLegendT: Record<MapLang, Record<string, string>> = {
  ...
  ht: { title: "Lejann", risk: "Nivo risk", depth: "Pwofondè", magnitude: "Magnitid", clusters: "Gwoupman", heatmap: "Kat chalè", liquefaction: "Likifaksyon" },
...
export const mapEventExtrasT: Record<MapLang, Record<string, string>> = {
  fr: { fallback: "Événement sismique", historical: "Événement historique (catalogue USGS)", tsunami: "Alerte tsunami possible", close: "Fermer" },
  ht: { fallback: "Evènman tranblemanntè", historical: "Evènman istorik (USGS)", tsunami: "Alèt tsunami posib", close: "Fèmen" },
  en: { fallback: "Seismic event", historical: "Historical event (USGS catalogue)", tsunami: "Possible tsunami alert", close: "Close" },
  es: { fallback: "Evento sísmico", historical: "Evento histórico (catálogo USGS)", tsunami: "Posible alerta de tsunami", close: "Cerrar" },
}
...
export const mapLegendOverlayT: Record<MapLang, Record<string, string>> = {
  ...
  ht: { legend: "Lejann", magnitude: "Magnitid (gwosè)", depth: "Nivo risk", faults: "Gwo fay", sept: "Septantriyonal", enriq: "Enriquillo-PG" },
...
export const mapFilterT: Record<MapLang, Record<string, string>> = {
  ...
  ht: { title: "Filt", magMin: "Magnitid min", depthMax: "Pwofondè max (km)", sources: "Sous done" },
...
export const mapLayerToggleT: Record<MapLang, { title: string; layers: Record<string, { label: string; desc: string }> }> = {
  ...
  ht: {
    ...
    layers: {
      ...
      liquefaction: { label: "Likifaksyon", desc: "Zòn risk tè" },
      riskZones: { label: "Zòn risk", desc: "Poligòn sismik" },
...
export const mapToolbarT: Record<MapLang, Record<string, string>> = {
  fr: { zoomIn: "Zoom avant", zoomOut: "Zoom arrière", centerHaiti: "Centrer Haïti", locateMe: "Ma position", geoDenied: "Géolocalisation refusée ou indisponible", geoUnsupported: "Géolocalisation non supportée", dark: "Fond sombre", satellite: "Satellite", layers: "Couches", filters: "Filtres" },
  ht: { zoomIn: "Zoom an", zoomOut: "Zoom deyò", centerHaiti: "Santre Ayiti", locateMe: "Pozisyon mwen", geoDenied: "Geolokalizasyon refize", geoUnsupported: "Geolokalizasyon pa sipòte", dark: "Fond nwa", satellite: "Satelit", layers: "Kouch", filters: "Filt" },
  en: { zoomIn: "Zoom in", zoomOut: "Zoom out", centerHaiti: "Center Haiti", locateMe: "My location", geoDenied: "Geolocation denied or unavailable", geoUnsupported: "Geolocation not supported", dark: "Dark basemap", satellite: "Satellite", layers: "Layers", filters: "Filters" },
  es: { zoomIn: "Acercar", zoomOut: "Alejar", centerHaiti: "Centrar Haití", locateMe: "Mi ubicación", geoDenied: "Geolocalización denegada", geoUnsupported: "Geolocalización no soportada", dark: "Mapa oscuro", satellite: "Satélite", layers: "Capas", filters: "Filtros" },
}
